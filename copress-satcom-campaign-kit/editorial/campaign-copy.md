...
1. One command center for local publishing.
2. Build the spine once. Publish everywhere.
3. Campaign kits, newsletters, billing, and city sites in one operator lane.
4. The local media dashboard built for real production days.
5. From brief to banner to bill, without rebuilding the workflow.
...
Local publishing breaks when every action lives in a different place. A story queue here. A Sendy note there. A city-site list in another tab. A billing request buried in email. CoPress Dashboard pulls those lanes into one visible operating surface so owners, editors, sales reps, and production teams can move from idea to publishable handoff.

## Banner Copy

Leaderboard:
One spine for local publishing. Campaigns, newsletters, billing, city sites, and operator handoff.

Medium rectangle:
Turn one brief into a full campaign kit. Assets, pricing, kanban, newsletter copy, and handoff files in one place.

Mobile:
CoPress command spine. Campaigns + billing + newsletter.

Social square:
Local media needs a spine. Editorial, ads, newsletters, city sites, billing, and operator handoff in one dashboard.
...
CTA: Open Campaign Kit

Secondary CTA: Operator Readiness Kit
...
- IM-210 Dashboard showcase landing page
- IM-315 Newsletter command-spine block
- IM-415 Display banner set
