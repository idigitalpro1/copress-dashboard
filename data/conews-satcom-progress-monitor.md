...
| PROV-506 | deployed candidate | advertiser campaign kit JSON/CSV/MD |
| PROV-507 | deployed candidate | weekly edition sample JSON/MD |
| PROV-508 | deployed candidate | this progress monitor packet |
